          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" method="post" action="{{url('/admin/post/update/'.$result['0']->id)}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" value="{{$result['0']->title}}" placeholder="Title" name="Slug">
                        @error('slug')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <input type="date" class="form-control" value="{{$result['0']->post_date}}"  name="post_date">
                        @error('post_date')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
